...
class PreloadCoreData {
    ...
    private func getSentences() -> Array<Sentence> {
        ...
        sentence.append(Sentence(id: 25, sentence: "Babka má vnučku?", video: "5/25"))
        ...
        sentence.append(Sentence(id: 153, sentence: "Pri ceste predávajú domáce zeleniny.", video: "26/153"))
    ...
    private func getDictionary() -> Array<Word>{
        ...
        dictionary.append(Word(name: "Nepočujúci",   lection: 0, order: 6,  videoFront: "1/Nepocujuci", videoSide: "1/Nepocujuci1", inDictionary: true, sentence: [0, 4, 15, 16]))
        ...
        dictionary.append(Word(name: "Nedoslýchaví", lection: 0, order: 10, videoFront: "1/Nedoslychavy", videoSide: "1/Nedoslychavy1", inDictionary: true, sentence: [17]))
        dictionary.append(Word(name: "Muž",          lection: 0, order: 11, videoFront: "1/Muz", videoSide: "1/Muz1", inDictionary: true, sentence: [16, 39]))
        dictionary.append(Word(name: "Žena",         lection: 0, order: 12, videoFront: "1/Zena", videoSide: "1/Zena1", inDictionary: true, sentence: [4, 10, 41]))
        dictionary.append(Word(name: "Chlapec",      lection: 0, order: 13, videoFront: "1/Chlapec", videoSide: "1/Chlapec1", inDictionary: true, sentence: [1, 38]))
        dictionary.append(Word(name: "Dievča",       lection: 0, order: 14, videoFront: "1/Dievca", videoSide: "1/Dievca1", inDictionary: true, sentence: [2, 159]))
        ...
        dictionary.append(Word(name: "Jeho/Jej", lection: 1, order: 3,  videoFront: "2/JehoJej", videoSide: "2/JehoJej1", inDictionary: true, sentence: [50, 19]))
        dictionary.append(Word(name: "Kto",      lection: 1, order: 4,  videoFront: "2/Kto", videoSide: "2/Kto1", inDictionary: true, sentence: [7, 92]))
        ...
        dictionary.append(Word(name: "Noc",             lection: 2, order: 4,  videoFront: "3/Noc", videoSide: "3/Noc1", inDictionary: true, sentence: [63, 101]))
        ...
        dictionary.append(Word(name: "Kamarát/ka",      lection: 2, order: 7,  videoFront: "3/Kamarat", videoSide: "3/Kamarat1", inDictionary: true, sentence: [15, 130]))
        ...
        dictionary.append(Word(name: "Stretnúť",        lection: 2, order: 13, videoFront: "3/Stretnut", videoSide: "3/Stretnut1", inDictionary: true, sentence: [100, 119]))
        ...
        //Lesson 4 - Rodina I
        dictionary.append(Word(name: "Mama",          lection: 3, order: 0, videoFront: "4/Mama", videoSide: "4/Mama1", inDictionary: true, sentence: [26, 135]))
        ...
        dictionary.append(Word(name: "Nemám",         lection: 3, order: 9, videoFront: "4/Nemam", videoSide: "4/Nemam1", inDictionary: true, sentence: [22, 29, 112]))
        dictionary.append(Word(name: "Babka",         lection: 3, order: 10, videoFront: "4/Babka", videoSide: "4/Babka1", inDictionary: true, sentence: [25, 55]))
        dictionary.append(Word(name: "Dedko",         lection: 3, order: 11, videoFront: "4/Dedko", videoSide: "4/Dedko1", inDictionary: true, sentence: [67]))
        dictionary.append(Word(name: "Dieťa",         lection: 3, order: 12, videoFront: "4/Dieta", videoSide: "4/Dieta1", inDictionary: true, sentence: [151]))
        ...
        dictionary.append(Word(name: "Vnučka",          lection: 4, order: 1,  videoFront: "5/Vnucka", videoSide: "5/Vnucka1", inDictionary: true, sentence: [25, 143]))
        dictionary.append(Word(name: "Manžel/ka",       lection: 4, order: 2,  videoFront: "5/Manzel", videoSide: "5/Manzel1", inDictionary: true, sentence: [29, 34]))
        ...
        dictionary.append(Word(name: "Manželia",        lection: 4, order: 4,  videoFront: "5/Manzelia", videoSide: "5/Manzelia1", inDictionary: true, sentence: []))
        ...
        dictionary.append(Word(name: "Žiť",             lection: 4, order: 10, videoFront: "5/Zit", videoSide: "5/Zit1", inDictionary: true, sentence: [86, 134]))
        dictionary.append(Word(name: "Spolu",           lection: 4, order: 11, videoFront: "5/Spolu", videoSide: "5/Spolu1", inDictionary: true, sentence: [34, 89]))
        ...
        dictionary.append(Word(name: "Farebná",     lection: 7, order: 9, videoFront: "8/Farebna", videoSide: "8/Farebna1", inDictionary: true, sentence: [162]))
        ...
        dictionary.append(Word(name: "Bývať",       lection: 9, order: 12, videoFront: "10/Byvat", videoSide: "10/Byvat1", inDictionary: true, sentence: [55]))
        ...
        dictionary.append(Word(name: "Chata",       lection: 10, order: 2, videoFront: "11/Chata", videoSide: "11/Chata1", inDictionary: true, sentence: [65, 138]))
        ...
        dictionary.append(Word(name: "Pozemok",     lection: 10, order: 5, videoFront: "11/Pozemok", videoSide: "11/Pozemok1", inDictionary: true, sentence: [58, 59, 60]))
        ...
        dictionary.append(Word(name: "Veľký",       lection: 10, order: 11, videoFront: "11/Velky", videoSide: "11/Velky1", inDictionary: true, sentence: [61, 70]))
        ...
        dictionary.append(Word(name: "Isť do",      lection: 10, order: 14, videoFront: "11/IstDo", videoSide: "11/IstDo1", inDictionary: true, sentence: [62]))
        ...
        dictionary.append(Word(name: "Zatvorené",   lection: 11, order: 14, videoFront: "12/Zatvorene", videoSide: "12/Zatvorene1", inDictionary: true, sentence: [70]))
        ...
        dictionary.append(Word(name: "Múzeum",      lection: 12, order: 1, videoFront: "13/Muzeum", videoSide: "13/Muzeum1", inDictionary: true, sentence: [73, 75]))
        ...
        dictionary.append(Word(name: "Ulica",       lection: 12, order: 7, videoFront: "13/Ulica", videoSide: "13/Ulica1", inDictionary: true, sentence: [7]))
        dictionary.append(Word(name: "Park",        lection: 12, order: 8, videoFront: "13/Park", videoSide: "13/Park1", inDictionary: true, sentence: [76]))
        dictionary.append(Word(name: "Hotel",       lection: 12, order: 9, videoFront: "13/Hotel", videoSide: "13/Hotel1", inDictionary: true, sentence: [76]))
        ...
        dictionary.append(Word(name: "Oproti",      lection: 12, order: 12, videoFront: "13/Oproti", videoSide: "13/Oproti1", inDictionary: true, sentence: [73]))
        ...
        dictionary.append(Word(name: "Mesto",               lection: 13, order: 11, videoFront: "14/Mesto", videoSide: "14/Mesto1", inDictionary: true, sentence: [81, 96, 99]))
...
//        dictionary.append(Word(name: "Škaredé",             lection: 13, order: 14, videoFront: "14/Skarede", videoSide: "14/Skarede1", inDictionary: true, sentence: []))
        ...
        dictionary.append(Word(name: "Nechcieť",        lection: 14, order: 11, videoFront: "15/Nechciet", videoSide: "15/Nechciet1", inDictionary: true, sentence: [87, 111]))
        ...
        dictionary.append(Word(name: "Motorka",     lection: 15, order: 1, videoFront: "16/Motorka", videoSide: "16/Motorka1", inDictionary: true, sentence: [94]))
        ...
        dictionary.append(Word(name: "Rieka",       lection: 16, order: 9, videoFront: "17/Rieka", videoSide: "17/Rieka1", inDictionary: true, sentence: [101]))
        ...
        //Lesson 17 - Čas I.
        dictionary.append(Word(name: "Čas",             lection: 17, order: 0, videoFront: "18/Cas", videoSide: "18/Cas1", inDictionary: true, sentence: [102, 105, 112]))
        ...
        dictionary.append(Word(name: "Kedy",            lection: 17, order: 11, videoFront: "18/Kedy", videoSide: "18/Kedy1", inDictionary: true, sentence: [107]))
        ...
        //Lesson 19 - Čas II.
        dictionary.append(Word(name: "Práca",           lection: 18, order: 0, videoFront: "19/Praca", videoSide: "19/Praca1", inDictionary: true, sentence: [108, 120]))
        ...
        dictionary.append(Word(name: "Každý",           lection: 18, order: 4, videoFront: "19/Kazdy", videoSide: "19/Kazdy1", inDictionary: true, sentence: [108]))
        ...
        dictionary.append(Word(name: "Bude",            lection: 18, order: 7, videoFront: "19/Bude", videoSide: "19/Bude1", inDictionary: true, sentence: []))
        dictionary.append(Word(name: "Bolo",            lection: 18, order: 8, videoFront: "19/Bolo", videoSide: "19/Bolo1", inDictionary: true, sentence: [114]))
        dictionary.append(Word(name: "Jesť",            lection: 18, order: 9, videoFront: "19/Jest", videoSide: "19/Jest1", inDictionary: true, sentence: [152]))
        dictionary.append(Word(name: "Odpočívať",       lection: 18, order: 10, videoFront: "19/Odpocivat", videoSide: "19/Odpocivat1", inDictionary: true, sentence: []))
        dictionary.append(Word(name: "Pred",            lection: 18, order: 11, videoFront: "19/Pred", videoSide: "19/Pred1", inDictionary: true, sentence: []))
        dictionary.append(Word(name: "Po",              lection: 18, order: 12, videoFront: "19/Po", videoSide: "19/Po1", inDictionary: true, sentence: []))
        dictionary.append(Word(name: "Asi",             lection: 18, order: 13, videoFront: "19/Asi", videoSide: "19/Asi1", inDictionary: true, sentence: []))
        dictionary.append(Word(name: "Až",              lection: 18, order: 14, videoFront: "19/Az", videoSide: "19/Az1", inDictionary: true, sentence: []))
        ...
        dictionary.append(Word(name: "Štvrtok",     lection: 19, order: 3, videoFront: "20/Štvrtok", videoSide: "20/Štvrtok1", inDictionary: true, sentence: [116]))
        ...
        dictionary.append(Word(name: "Sviatok",     lection: 19, order: 8, videoFront: "20/Sviatok", videoSide: "20/Sviatok1", inDictionary: true, sentence: [120]))
        dictionary.append(Word(name: "Dnes",        lection: 19, order: 9, videoFront: "20/Dnes", videoSide: "20/Dnes1", inDictionary: true, sentence: [101, 116]))
        ...
        dictionary.append(Word(name: "November",    lection: 20, order: 10, videoFront: "21/Novebmer", videoSide: "21/Novebmer1", inDictionary: true, sentence: []))
        ...
        dictionary.append(Word(name: "Niektoré",    lection: 23, order: 14, videoFront: "24/Niektory", videoSide: "24/Niektory1", inDictionary: true, sentence: []))
        ...
        dictionary.append(Word(name: "Mandarinka",  lection: 24, order: 3, videoFront: "25/Mandarinka", videoSide: "25/Mandarinka1", inDictionary: true, sentence: []))
        ...
        dictionary.append(Word(name: "Broskyňa",    lection: 24, order: 9, videoFront: "25/Borskyna", videoSide: "25/Borskyna1", inDictionary: true, sentence: []))
        dictionary.append(Word(name: "Sladké",      lection: 24, order: 10, videoFront: "25/Sladke", videoSide: "25/Sladk1e", inDictionary: true, sentence: [148]))
