...
class PreloadCoreData {
    ...
    private func getDictionary() -> Array<Word>{
        ...
        dictionary.append(Word(name: "Koľko",           lection: 6, order: 12, videoFront: "7/Kolko", videoSide: "7/Koklo1", inDictionary: true, sentence: [36]))
        ...
        //Lesson 14 - Mestá I.
        dictionary.append(Word(name: "Bratislava",          lection: 13, order: 0, videoFront: "14/Bratislava", videoSide: "14Bratislava1", inDictionary: true, sentence: [79]))
        dictionary.append(Word(name: "Košice",              lection: 13, order: 1, videoFront: "14/Kosice", videoSide: "14/Kosice1", inDictionary: true, sentence: [88]))
        dictionary.append(Word(name: "Nitra",               lection: 13, order: 2, videoFront: "14/Nitra", videoSide: "14/Nitra1", inDictionary: true, sentence: [89]))
        dictionary.append(Word(name: "Žilina",              lection: 13, order: 3, videoFront: "14/Zilina", videoSide: "14/Zilina1", inDictionary: true, sentence: [78]))
        dictionary.append(Word(name: "Banská Bystrica",     lection: 13, order: 4, videoFront: "14/BB", videoSide: "14/BB1", inDictionary: true, sentence: []))
        dictionary.append(Word(name: "Lučenec",             lection: 13, order: 5, videoFront: "14/Lucenec", videoSide: "14/Lucenec1", inDictionary: true, sentence: []))
        dictionary.append(Word(name: "Poprad",              lection: 13, order: 06, videoFront: "14/Poprad", videoSide: "14/Poprad1", inDictionary: true, sentence: [82]))
        dictionary.append(Word(name: "Liptovský Mikuláš",   lection: 13, order: 7, videoFront: "14/LM", videoSide: "14/LM1", inDictionary: true, sentence: []))
        dictionary.append(Word(name: "Prešov",              lection: 13, order: 8, videoFront: "14/Presov", videoSide: "14/Presov1", inDictionary: true, sentence: [81]))
        dictionary.append(Word(name: "Trnava",              lection: 13, order: 9, videoFront: "14/Trnava", videoSide: "14/Trnava1", inDictionary: true, sentence: []))
        dictionary.append(Word(name: "Mesto",               lection: 13, order: 10, videoFront: "14/Mesto", videoSide: "14/Mesto1", inDictionary: true, sentence: [81, 96, 99]))
        dictionary.append(Word(name: "Dedina",              lection: 13, order: 11, videoFront: "14/Dedina", videoSide: "14/Dedina1", inDictionary: true, sentence: [80, 83]))
        dictionary.append(Word(name: "Okres",               lection: 13, order: 12, videoFront: "14/Okres", videoSide: "14/Okres1", inDictionary: true, sentence: []))
        ...
        dictionary.append(Word(name: "Dráha",       lection: 15, order: 13, videoFront: "16/Draha", videoSide: "16/Draha1", inDictionary: true, sentence: []))
        dictionary.append(Word(name: "Lacná",       lection: 15, order: 14, videoFront: "16/Lacna", videoSide: "16/Lacna1", inDictionary: true, sentence: []))
