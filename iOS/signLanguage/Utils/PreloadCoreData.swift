...
class PreloadCoreData {
    ...
    private func getLection() -> Array<Lection> {
        ...
        lection.append(Lection(id: 7, title: "Farby I.", image: "nemo-top" ))
        lection.append(Lection(id: 8, title: "Farby II.", image: "nemo-top" ))
    ...
    private func getSentences() -> Array<Sentence> {
        ...
        sentence.append(Sentence(id: 101, sentence: "Včera v noci auto a autobus havarovali pri tuneli vedľa rieky.", video: "sample_2"))
    ...
    private func getDictionary() -> Array<Word>{
        ...
        dictionary.append(Word(name: "Stretnúť", lection: 2, videoFront: "sample_2", videoSide: "", inDictionary: true, sentence: [100]))
        dictionary.append(Word(name: "Opakovať", lection: 2, videoFront: "sample_2", videoSide: "", inDictionary: true, sentence: []))

        //Lesson 4 - Rodina I
        dictionary.append(Word(name: "Mama", lection: 3, videoFront: "sample_2", videoSide: "", inDictionary: true, sentence: [26]))
        ...
        dictionary.append(Word(name: "Žiť", lection: 4, videoFront: "sample_2", videoSide: "", inDictionary: true, sentence: [86]))
        ...
        dictionary.append(Word(name: "Chata", lection: 10, videoFront: "sample_2", videoSide: "", inDictionary: true, sentence: [65]))
        ...
        dictionary.append(Word(name: "Vedľa", lection: 11, videoFront: "sample_2", videoSide: "", inDictionary: true, sentence: [75, 101]))
        ...
        //Lesson 19 - Čas II.
        dictionary.append(Word(name: "Práca", lection: 18, videoFront: "sample_2", videoSide: "", inDictionary: true, sentence: [108]))
        ...
        dictionary.append(Word(name: "Dnes", lection: 19, videoFront: "sample_2", videoSide: "", inDictionary: true, sentence: [101]))
