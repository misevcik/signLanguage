...
class PreloadCoreData {
    ...
    private func getLection() -> Array<Lection> {
        ...
        lection.append(Lection(id: 9, title: "Bývanie I.", image: "nemo-top" ))
        lection.append(Lection(id: 10, title: "Bývanie II.", image: "nemo-top" ))
        lection.append(Lection(id: 11, title: "Inštitúcie I.", image: "nemo-top" ))
        lection.append(Lection(id: 12, title: "Inštitúcie II.", image: "nemo-top" ))
        lection.append(Lection(id: 13, title: "Mestá I.", image: "nemo-top" ))
        lection.append(Lection(id: 14, title: "Mestá II.", image: "nemo-top" ))
        lection.append(Lection(id: 15, title: "Doprava I.", image: "nemo-top" ))
        lection.append(Lection(id: 16, title: "Doprava II.", image: "nemo-top" ))
        lection.append(Lection(id: 17, title: "Čas I.", image: "nemo-top" ))
        lection.append(Lection(id: 18, title: "Čas II.", image: "nemo-top" ))
        lection.append(Lection(id: 19, title: "Kalendár I.", image: "nemo-top" ))
        lection.append(Lection(id: 20, title: "Kalendár II.", image: "nemo-top" ))
        lection.append(Lection(id: 21, title: "Zvierata I.", image: "nemo-top" ))
        lection.append(Lection(id: 22, title: "Zvierata II.", image: "nemo-top" ))
        lection.append(Lection(id: 23, title: "Zvierata III.", image: "nemo-top" ))
        lection.append(Lection(id: 24, title: "Ovocie", image: "nemo-top" ))
        lection.append(Lection(id: 25, title: "Zelenina", image: "nemo-top" ))
        lection.append(Lection(id: 26, title: "Ročné obdobie I.", image: "nemo-top" ))
        lection.append(Lection(id: 27, title: "Ročné obdobie II.", image: "nemo-top" ))
    ...
    private func getDictionary() -> Array<Word>{
        ...
        dictionary.append(Word(name: "Vnučka", lection: 4, videoFront: "sample_2", videoSide: "", inDictionary: true, sentence: [25]))
        ...
        dictionary.append(Word(name: "Báť sa", lection: 22, videoFront: "sample_2", videoSide: "", inDictionary: true, sentence: [135]))
        ...
        dictionary.append(Word(name: "Zima", lection: 26, videoFront: "sample_2", videoSide: "", inDictionary: true, sentence: [136]))
        ...
        dictionary.append(Word(name: "Krásne", lection: 26, videoFront: "sample_2", videoSide: "", inDictionary: true, sentence: [132]))
